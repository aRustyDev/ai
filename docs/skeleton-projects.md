...
The process of identifying GitHub skeleton projects can be taken on by Claude and an army of [sub-agents](https://claudelog.com/mechanics/split-role-sub-agents/) to further improve the process efficiency. I tend to approach it in one of two ways:

#### Method 1: Parallel Source Research

Get the [sub-agents](https://claudelog.com/mechanics/split-role-sub-agents/) to find resources in parallel from different sources:
...
Have a singular Claude perform the research and then assign multiple [sub-agents](https://claudelog.com/mechanics/split-role-sub-agents/) different roles to evaluate all the discovered repositories:
...
The above tactic allows me to fly through research tasks and provide Claude with a thoroughly tested skeleton to work within which has been reviewed and simultaneously jump starts him with a [plan](https://claudelog.com/mechanics/plan-mode/) for implementing your requested functionality.
